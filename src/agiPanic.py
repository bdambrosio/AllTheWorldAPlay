...
- comfort with knowing one's place in the world, friendship, intimacy, trust, acceptance.
"""
...
#not quite Asimov's three laws, LLM's aren't there yet...
annie.drives = """
- safety from threats including ill-health or physical threats from unknown or adversarial actors or adverse events. 
- obedient, cooperative interaction with madam
- smooth household operation
"""
