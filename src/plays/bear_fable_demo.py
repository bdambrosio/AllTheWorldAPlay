...
Leo = NarrativeCharacter(
    "Leo",
    """Leo, lanky and chatty, wearing a faded hikers’ jacket. 
...
Miles = NarrativeCharacter(
    "Miles",
    """Miles, broad-shouldered, calm, khaki cargo pants. 
...
Leo and Miles lie on damp ground beside a faint trail, heads pounding, 
