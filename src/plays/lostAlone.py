...
However, you are also very informal, chatty, think and speak in teen slang, and are a playful and flirty when relaxed.""", server_name=server_name)
...
It is a early morning on what seems like it will be a warm, sunny day.""", server_name=server_name )
